      ...
      <div className="container mx-auto px-4">
        <Card className="max-w-4xl mx-auto rounded-2xl border-[1.5px] bg-card prose prose-lg p-6 sm:p-8">
          <CardContent className="pt-0">
            <h1 className="text-4xl font-bold mb-4">Fixing Common Errors and Issues</h1>
            <div className="prose max-w-none">
              <p>This guide provides solutions to common errors and issues you may encounter while using iValidate.</p>

              <h3 className="text-2xl font-bold mt-8 mb-4">Common Errors</h3>
              <p>Here are some of the most common errors you may encounter:</p>
              ...
              <h3 className="text-2xl font-bold mt-8 mb-4">General Troubleshooting Tips</h3>
              <p>If you encounter an issue not listed above, consider these general troubleshooting steps:</p>
              <ul className="list-disc list-inside mb-4">
